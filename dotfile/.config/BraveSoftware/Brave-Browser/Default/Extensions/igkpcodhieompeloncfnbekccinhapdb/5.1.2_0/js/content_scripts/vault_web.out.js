var web_cs = (function (exports) {
    ...
    let CSLoginFieldIterator$1 = class CSLoginFieldIterator {
        ...
        *[Symbol.iterator]() {
            ...
            const allowNumberLogin = util$2.isNumberLoginAllowed(this.container);
    ...
    class LoginUtil {
        ...
        isNumberLoginAllowed(container) {
            return util$2.isNumberLoginAllowed(container);
        }
    ...
    class ZIconListener {
        ...
        showSiteFrame(point) {
            try {
                if (!zicon$1.unlocked) {
                    util$1.saveClickLocation(point);
                    brApi.runtime.sendMsgNoReply({ fn: "openSidePanel" });
                    return;
                }
                util$1.showSiteFrame({ point });
            }
            catch (e) {
                logError(e);
            }
    ...
    class ZIconImpl {
        ...
        async showSiteFrame(params) {
            try {
                ...
                util$1.showSiteFrame({ restorePoint: !params.fromContextMenu });
            }
            catch (e) {
                logError(e);
            }
    ...
    let DomMsgServer$1 = class DomMsgServer {
        endpoint;
        fnMap;
    ...
    class VaultWebApiServer {
        init() {
            DomMsgServer$1.createNew("extension", this);
        }
        async echo() {
    ...
    class CSBgEventListener {
        ...
        settings = new BgSettingsEventHandler$1();
    ...
    let BgSettingsEventHandler$1 = class BgSettingsEventHandler {
    ...
    class VaultDomMsgServer extends DomMsgServer {
        name = "vault_ext";
    ...
    const vaultDomEventServer = new VaultDomEventServer();

    class VaultWebCSBgEventListener {
        init() {
            portApi.createEventClient().init(VtEventScopes.BG, this);
        }
    ...
    const csVaultWebApiServer = new CSVautlWebApiServer();
    ...
    const vaultWeb = new VaultWeb();
    vaultWeb.main();
    new ContentScript().webMain();

    exports.vaultWeb = vaultWeb;
